...
SENSOR_DESCRIPTIONS: tuple[SmartSensorEntityDescription, ...] = (
    ...
    SmartSensorEntityDescription(
        ...
        icon="mdi:palette",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.vehicle.color_name or None,
    ),
    SmartSensorEntityDescription(
        key="color_code",
        translation_key="color_code",
        icon="mdi:palette-swatch",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.color_code or None,
    ),
    SmartSensorEntityDescription(
        key="model_code",
        translation_key="model_code",
        icon="mdi:car-info",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.vehicle.model_code or None,
    ),
    SmartSensorEntityDescription(
        key="factory_code",
        translation_key="factory_code",
        icon="mdi:factory",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.factory_code or None,
    ),
    SmartSensorEntityDescription(
        key="series_name",
        translation_key="series_name",
        icon="mdi:car-multiple",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.vehicle.series_name or None,
    ),
    SmartSensorEntityDescription(
        key="vehicle_type",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.vehicle_type or None,
    ),
    SmartSensorEntityDescription(
        key="mat_code",
        translation_key="mat_code",
        icon="mdi:barcode",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ...
    SmartSensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.fuel_tank_capacity or None,
    ),
    SmartSensorEntityDescription(
        key="ihu_platform",
        translation_key="ihu_platform",
        icon="mdi:monitor-dashboard",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.ihu_platform or None,
    ),
    SmartSensorEntityDescription(
        key="tbox_platform",
        translation_key="tbox_platform",
        icon="mdi:access-point",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.tbox_platform or None,
    ),
    SmartSensorEntityDescription(
        key="vehicle_photo_url",
        translation_key="vehicle_photo_url",
        icon="mdi:image",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.vehicle.vehicle_photo_big or data.vehicle.vehicle_photo_small or None,
    ),
    # ── Running State Extended ─────────────────────────────────────────
    SmartSensorEntityDescription(
        key="engine_status",
        translation_key="engine_status",
        icon="mdi:engine",
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.running_state.engine_status if data.running_state else None,
    ),
    SmartSensorEntityDescription(
        key="usage_mode",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.running_state.usage_mode if data.running_state else None,
    ),
    SmartSensorEntityDescription(
        key="car_mode",
        translation_key="car_mode",
        icon="mdi:car-shift-pattern",
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.running_state.car_mode if data.running_state else None,
    ),
    # ── GPS Additional ─────────────────────────────────────────────────
    SmartSensorEntityDescription(
        key="altitude",
        ...
        state_class=SensorStateClass.MEASUREMENT,
        value_fn=lambda data: data.status.altitude,
    ),
    # ── Trip Journal Extended ──────────────────────────────────────────
    SmartSensorEntityDescription(
    ...
    SmartSensorEntityDescription(
        ...
        icon="mdi:map-marker-radius",
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.last_trip.start_address if data.last_trip else None,
    ),
    SmartSensorEntityDescription(
        ...
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.last_trip.end_address if data.last_trip else None,
    ),
    SmartSensorEntityDescription(
        key="total_trips",
        ...
        icon="mdi:counter",
        state_class=SensorStateClass.TOTAL_INCREASING,
        value_fn=lambda data: data.total_trips,
    ),
    SmartSensorEntityDescription(
        key="vehicle_image_path",
        translation_key="vehicle_image_path",
        icon="mdi:image",
        entity_registry_enabled_default=True,
        value_fn=lambda data: data.vehicle_image_path or None,
    ),
)
